...
Original file is located at
    https://colab.research.google.com/drive/1aZFEObl-AZApKV2fajl5PNOOLAoDz4Nn
"""
...
action = exploratory_policy((0,0), 0.5)
print(f"Action takes in state (0,0): {action=}")
...
plot_action_values(action_values)
#  最善手でないところを切り上げているためゴールに直結しないQValueは-100のまま
# On-policyはそこもある程度Qが変化していた

plot_policy(action_values, frame)
# Onpolicyと違って関係ないActionの更新はない
