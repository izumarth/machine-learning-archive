...
Original file is located at
    https://colab.research.google.com/drive/1MXpdHHTBTGo0u2AFNqQeDUmZy5fPjzxu
"""
...
def n_step_sarsa(action_values, policy, episodes, alpha=0.1, gamma=0.99, epsilon=0.2, n=8):
  for episode in range(1, episodes + 1):
    ...
    while t-n < len(transitions):
      ...
      # n-Step のnに達していない場合は更新に足る情報が揃っていないためQ-Valueの更新ができない
      if t >= n:
        # G = r1 + gamma * r2 ..... + gamma^n * Q(Sn, An)
